...
var clientRawName = "clientraw.txt", //The names of your clientraw files
    ...
    customBaseURL = "/wdisplay/", //false, // OPTIONAL: Set the path to where your clientraw files are uploaded e.g., "http://www.goldenbaynzweather.info/wdl/" (note: final backslash and quotation marks must be included). Otherwise leave as: false
