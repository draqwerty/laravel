...
// ========================================
$time =  '1:39 PM';	// current time
$date =  '17/1/2021';	// current date
$sunrise =  '6:16 am';	// sun rise time (make sure you have the correct lat/lon
// 		            in view/sun moon)
$time_minute =  '39';	// Current minute
$time_hour =  '13';	// Current hour
$date_day =  '17';	// Current day
...
$sunset =  '8:41 pm';	// sunset time
$moonrisedate =  '17/01/21';	// moon rise date
$moonrise =  '10:08 am';	// moon rise time
$moonsetdate =  '17/01/21';	// moon set date
$moonset =  '11:30 pm';	// moon set time
$moonage =  'Moon age: 3 days,22 hours,28 minutes,17%';	// current age of the moon (days since new moon)
$moonphase =  '17%';	// Moon phase %
...
$hoursofpossibledaylight =  '14:25';	// Total hours/minutes of possible daylight for today
//
...
$windowsuptime = '1 Days 19 Hours 55 Minutes 50 Seconds'; // uptime for windows on weather pc
$freememory = '16.86GB'; // amount of free memory on the pc
...
//
$timeofnextupdate =  '1:40 pm';	// Time of next Update/Upload of the weather data to your web page (based on the web table update
//
...
$tempnodp = '17'; // temperature, no decimal place
$humidity =  '61';	// humidity
$dewpt =  '9.0';	// dew point
$maxtemp =  '16.7';	// today's maximum temperature
$maxtempt =  '1:32 PM';	// time this occurred
$mintemp =  '10.0';	// today's minimum temperature
$mintempt =  '5:51 AM';	// time this occurred
$feelslike =  '17';	// Shows heat index or humidex or windchill (if less than 16oC)

$heati =  '16.6';	// current heat index
$heatinodp =  '17';	// current heat index,no decimal place
$windch =  '16.6';	// current wind-chill
$windchnodp =  '17';	// current wind-chill, no decimal place
$humidexfaren =  '63.4';	// Humidex value in oF
$humidexcelsius =  '17.5';	// Humidex value in oC

$apparenttemp =  '16.6';	// Apparent temperature
$apparentsolartemp =  '16.6';	// Apparent temperature in the sun (you need a solar sensor)
$apparenttempc =  '16.6';	// Apparent temperature, �C
$apparentsolartempc =  '16.6';	// Apparent temperature in the sun, �C (you need a solar sensor)
$apparenttempf =  '61.9';	// Apparent temperature, �F
$apparentsolartempf =  '61.9';	// Apparent temperature in the sun, �F (you need a solar sensor)
//
...
$maxtempyest =  '16.8';	// Yesterday's max temperature
$maxtempyestt =  '3:51 PM';	// Time of yesterday's max temperature
$mintempyest =  '8.0';	// Yesterday's min temperature
$mintempyestt =  '4:48 AM';	// Time of yesterday's min temperature
//
//
// Trends:
// -------
$temp24hoursago =  '12.6';	// The temperature 24 hours ago
$humchangelasthour =  '-3';	// Humidity change last hour
$dewchangelasthour =  '+0.2';	// Dew point change last hour
$barochangelasthour =  '-0.1';	// Baro change last hour
//
// Wind
// ====
// Current:
// --------
//
$avgspd =  '1.4';	// average wind speed (current)
$gstspd =  '2.9';	// current/gust wind speed
$maxgst =  '18.5';	// today's maximum wind speed
$maxgstt =  '12:52 PM';	// time this occurred
$maxgsthr =  '18.0 kmh   S';	// maximum gust last hour
$dirdeg =  '172';	// wind direction (degrees)
$dirlabel =  'S';	// wind direction (NNE etc)
//$maxgustlastimediatehourtime =  '12:52';	// 12:52  time that the max gust last prior 1 hour occured
$avwindlastimediate10 =  '2.2';	// Average wind for the last immediate 10 minute period
// $avdir10minute =  '127';	// average ten minute wind direction (degrees)
...
// Current:
// --------
$baro = '1017.5';  // current barometer
$baroinusa2dp =  '30.05 inches';	// Current barometer reading in inches, 2 decimal places only.
...
// Yesterday:
// ----------
$yesterdayrain =  '1.9';	// Yesterday rain
//
...
// Sunshine/Solar/ET
// =================
$VPsolar =  '418';	//  Solar energy number (W/M2)
$VPuv =  '5.7';	// UV number
$highsolar =  '1207';	// Daily high solar (for Davis VP and Grow stations)
$highuv =  '18.3';	// Daily high UV (for Davis VP stations)
$currentsolarpercent =  '0';	// Current solar percent for stations with a temperature solar sensor (like the dallas 1 wire)
$highsolartime =  '12:59 PM';	// Time that the daily high solar occured
$lowsolartime =  '12:00 AM';	// Time that the daily low solar occured
$highuvtime =  '12:59 PM';	// Time that the daily high UV occured
$lowuvtime =  '12:00 AM';	// Time that the daily low UV occured
$highuvyest =  '15.9';	// Yesterday's high UV
$highuvyesttime =  '3:31 PM';	// Time of yesterday's high UV
$burntime =  '20';	// Time (minutes) to burn (normal skin) at the current UV rate, from the Davis VP with UV sensor
//
// the solar setup.
//
//
...
$snowheight = '126';	// Estimated height snow will fall at
$snowheightnew = '2020';	// Estimated height snow will fall at, new formula
//
...
//
$temp0minuteago = '16.6';  // ****this one is needed for all the others to work
$wind0minuteago = '1.9';
$gust0minuteago = '5.6';
$dir0minuteago = ' SE';
$hum0minuteago = '61';
$dew0minuteago = '9.0';
$baro0minuteago = '1017.5';
$rain0minuteago = '0.0';
$VPsolar0minuteago = '0';
$VPuv0minuteago = '5.7';
...
$hum5minuteago = '60';
$dew5minuteago = '8.9';
$baro5minuteago = '1017.5';
$rain5minuteago = '0.0';
$VPsolar5minuteago = '0';
$VPuv5minuteago = '4.6';

$temp10minuteago = '16.1';
$wind10minuteago = '0.0';
$gust10minuteago = '11.1';
$dir10minuteago = ' S ';
$hum10minuteago = '60';
$dew10minuteago = '8.3';
$baro10minuteago = '1017.6';
$rain10minuteago = '0.0';
$VPsolar10minuteago = '0';
$VPuv10minuteago = '16.9';

$temp15minuteago = '15.6';
$wind15minuteago = '0.0';
$gust15minuteago = '5.6';
$dir15minuteago = ' E ';
$hum15minuteago = '64';
$dew15minuteago = '8.8';
$baro15minuteago = '1017.6';
$rain15minuteago = '0.0';
$VPsolar15minuteago = '0';
$VPuv15minuteago = '12.9';

$temp20minuteago = '15.9';
$wind20minuteago = '1.9';
$gust20minuteago = '3.7';
$dir20minuteago = ' SE';
$hum20minuteago = '64';
$dew20minuteago = '9.1';
$baro20minuteago = '1017.5';
$rain20minuteago = '0.0';
$VPsolar20minuteago = '0';
$VPuv20minuteago = '3.0';

$temp30minuteago = '16.3';
$wind30minuteago = '1.9';
$gust30minuteago = '5.6';
$dir30minuteago = 'ESE';
$hum30minuteago = '63';
$dew30minuteago = '9.3';
$baro30minuteago = '1017.5';
$rain30minuteago = '0.0';
$VPsolar30minuteago = '0';
$VPuv30minuteago = '10.1';

$temp45minuteago = '16.1';
$wind45minuteago = '5.6';
$gust45minuteago = '18.5';
$dir45minuteago = ' SE';
$hum45minuteago = '61';
$dew45minuteago = '8.6';
$baro45minuteago = '1017.6';
$rain45minuteago = '0.0';
$VPsolar45minuteago = '0';
$VPuv45minuteago = '5.4';

$temp60minuteago = '15.6';
$wind60minuteago = '1.9';
$gust60minuteago = '5.6';
$dir60minuteago = ' SE';
$hum60minuteago = '64';
$dew60minuteago = '8.8';
$baro60minuteago = '1017.6';
$rain60minuteago = '0.0';
$VPsolar60minuteago = '0';
$VPuv60minuteago = '3.9';

$temp75minuteago = '16.1';
$wind75minuteago = '1.9';
$gust75minuteago = '7.4';
$dir75minuteago = ' SE';
$hum75minuteago = '60';
$dew75minuteago = '8.3';
$baro75minuteago = '1017.5';
$rain75minuteago = '0.0';
$VPsolar75minuteago = '0';
$VPuv75minuteago = '4.0';

$temp90minuteago = '15.2';
$wind90minuteago = '0.0';
$gust90minuteago = '3.7';
$dir90minuteago = 'NNW';
$hum90minuteago = '64';
$dew90minuteago = '8.4';
$baro90minuteago = '1017.6';
$rain90minuteago = '0.0';
$VPsolar90minuteago = '0';
$VPuv90minuteago = '5.7';

$temp105minuteago = '15.2';
$wind105minuteago = '1.9';
$gust105minuteago = '5.6';
$dir105minuteago = 'NNW';
$hum105minuteago = '69';
$dew105minuteago = '9.5';
$baro105minuteago = '1017.8';
$rain105minuteago = '0.0';
$VPsolar105minuteago = '0';
$VPuv105minuteago = '7.2';
...
$dir120minuteago = ' NW';
$hum120minuteago = '69';
$dew120minuteago = '10.0';
$baro120minuteago = '1017.7';
$rain120minuteago = '0.0';
$VPsolar120minuteago = '0';
$VPuv120minuteago = '14.8';
...
$highbaro = '1018.0 ';
$highbarot = '9:36 AM';
$highsolaryest = '1011.0';
$highsolaryesttime = '3:31 PM';
$hourrn = '0.0';
$maxaverageyest = '6.8';
$maxaverageyestt = '6:15 PM';
$maxavgdirectionletter = 'SSE';
$maxavgspd = '6.8';
$maxavgspdt = '12:53 PM';
$maxbaroyest = '1015.0 ';
$maxbaroyestt = '10:32 PM';
$maxgstdirectionletter = '  S';
$maxgustyest = '13.3 kmh  SW';
$maxgustyestt = '5:11 PM';
$mcoldestdayonrecord = '12.6C  on: 16 Jan 2021';
$mcoldestnightonrecord = '9.2C  on: 16 Jan 2021';
$minchillyest = '8.0';
$minchillyestt = '4:48 AM';
$minwindch = '10.0';
$minwindcht = '5:51 AM';
...
$windruntodatethismonth = '713.61 km';
$windruntodatethisyear = '713.61 km';
$windruntoday = '12.80';
...
//
//
$cloudheightfeet =  '3113';	// Estimated cloud base height, feet, (based on dew point, and you height above sea  level...enter
$cloudheightmeters =  '949';	// Estimated cloud base height, metres, (based on dew point, and you height above sea

// end of stock testtags.txt

// ----------------------------------------------------------------------------------------------------
// begin mchallis tags added to testtags.txt for printable flyer
$maxgsthrtime = '12:52';        // time that the max gust last prior 1 hour occured
$minbaroyest  = '1009.6 ';
$minbaroyestt = '12:05 AM';
...
$avwindlastimediate60 = '2.3'; // average wind speed
$avwindlastimediate120 = '1.9'; // average wind speed
$currentmonthaveragerain = '---'; // average rain for current month
//
// version 5.00+
$avwindlastimediate15 = '1.9'; // average wind speed
$avwindlastimediate30 = '2.3'; // average wind speed
$todayhihumidex = '17.7'; //daily high humidex
$todaylohumidex = '11.1'; //Daily low Humidex
//Version 5.02
$dayornight = 'Day'; // Day or night flag

//Version 6.20
$tempchangelasthourfaren = '+1.8'; //For snow prediction
$abshum = '6.02'; //For snow prediction
...
$avtempnovnow = '0.0';
$avtempdecnow = '15.0';
$avtempjan = '17.4';//Average temperature for january from your data
...
$avtempweek = '17.5';    // Average Weekly Temp
$hddday = '4.1';        // Heating Degree for day
$hddmonth = '34.6';    // Heating Degree for month to date
$hddyear = '34.6';    // Heating Degree for year to date
...
$maxheatweek = '31.6';  // Maximum Heat Index for the Week *** NEW IN V2.00
$airdensity = '1.22';  //air density
$solarnoon = '13:28'; // Solar noon
$changeinday = '-00:01:30';  // change in day length since yesterday
$etcurrentweek = '5.6'; // ET total for the last 7 days
$sunshinehourstodateday = '01:07';
$sunshinehourstodatemonth = '18:23';
$maxsolarfortime = '0';
$wetbulb = '12.7';
...
$maxheatt = '1:32 PM';
$maxheatyest = '16.8';
$yeartodateavtemp = '17.4';
$monthtodateavtemp = '17.4';
$maxchillyest = '16.8';
...
$sunshinehourstodateyear = '18:23';
$sunshineyesterday = '01:07';
$avtempsincemidnight = '12.0';
$yesterdayavtemp = '11.5';
$avgspeedsincereset = '0.9';
$maxheatyestt = '3:51 PM';
$windrunyesterday = '19.73';
$currentwdet = '0.4';
$yesterdaywdet = '0.2';
$highhum = '99';
$highhumt = '7:50 AM';
